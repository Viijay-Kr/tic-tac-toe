...
class Game(models.Model):
  ...
  status =  models.CharField(max_length=30,choices=GameStatus.choices,default=GameStatus.IDLE)
  ...
  player_1_mark = models.CharField(max_length=30,choices=PlayerMark.choices,default=PlayerMark.CIRCLE)
  player_2_mark = models.CharField(max_length=30,choices=PlayerMark.choices,default=PlayerMark.CROSS)
